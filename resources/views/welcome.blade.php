...
<body>
    ...
    <div class="gallery-container">
        ...
        <div class="gallery-item">
            <img src="{{ asset('images/Cheeseburger.jpeg') }}" alt="Cheeseburger">
            <div class="burger-label">Cheeseburger</div>
        </div>

        <!-- Bild 2: Oklahoma -->
        <div class="gallery-item">
            <img src="{{ asset('images/Oklahoma.jpeg') }}" alt="Oklahoma Burger">
            <div class="burger-label">Oklahoma</div>
        </div>

        <!-- Bild 3: Jalapeño -->
        <div class="gallery-item">
            <img src="{{ asset('images/Jalapeno.jpeg') }}" alt="Jalapeño Burger">
